...
if ( !function_exists( 'axiom_welldone_template_services_5_theme_setup' ) ) {
	add_action( 'axiom_welldone_action_before_init_theme', 'axiom_welldone_template_services_5_theme_setup', 1 );
	function axiom_welldone_template_services_5_theme_setup() {
		axiom_welldone_add_template(array(
			'layout' => 'services-5',
			'template' => 'services-5',
			'mode'   => 'services',
			'need_columns' => true,
			'title'  => esc_html__('Services /Style 5/', 'axiom-welldone'),
...
// Template output
if ( !function_exists( 'axiom_welldone_template_services_5_output' ) ) {
	function axiom_welldone_template_services_5_output($post_options, $post_data) {
