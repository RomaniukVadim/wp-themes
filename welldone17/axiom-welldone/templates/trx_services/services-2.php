...
if ( !function_exists( 'axiom_welldone_template_services_2_theme_setup' ) ) {
	add_action( 'axiom_welldone_action_before_init_theme', 'axiom_welldone_template_services_2_theme_setup', 1 );
	function axiom_welldone_template_services_2_theme_setup() {
		axiom_welldone_add_template(array(
			'layout' => 'services-2',
			'template' => 'services-2',
			'mode'   => 'services',
			'need_columns' => true,
			'title'  => esc_html__('Services /Style 2/', 'axiom-welldone'),
...
// Template output
if ( !function_exists( 'axiom_welldone_template_services_2_output' ) ) {
	function axiom_welldone_template_services_2_output($post_options, $post_data) {
