...
if ( !function_exists( 'axiom_welldone_template_news_portfolio_theme_setup' ) ) {
	add_action( 'axiom_welldone_action_before_init_theme', 'axiom_welldone_template_news_portfolio_theme_setup', 1 );
	function axiom_welldone_template_news_portfolio_theme_setup() {
		axiom_welldone_add_template(array(
			'layout' => 'news-portfolio',
			'template' => 'news-portfolio',
			'mode'   => 'news',
			'title'  => esc_html__('Recent News /Style Portfolio/', 'axiom-welldone'),
...
// Template output
if ( !function_exists( 'axiom_welldone_template_news_portfolio_output' ) ) {
	function axiom_welldone_template_news_portfolio_output($post_options, $post_data) {
