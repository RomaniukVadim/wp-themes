...
if ( !function_exists( 'axiom_welldone_template_testimonials_2_theme_setup' ) ) {
	add_action( 'axiom_welldone_action_before_init_theme', 'axiom_welldone_template_testimonials_2_theme_setup', 1 );
	function axiom_welldone_template_testimonials_2_theme_setup() {
		axiom_welldone_add_template(array(
			'layout' => 'testimonials-2',
			'template' => 'testimonials-2',
			'mode'   => 'testimonials',
			'title'  => esc_html__('Testimonials /Style 2/', 'axiom-welldone')
		));
	}
}

// Template output
if ( !function_exists( 'axiom_welldone_template_testimonials_2_output' ) ) {
	function axiom_welldone_template_testimonials_2_output($post_options, $post_data) {
		$show_title = true;
